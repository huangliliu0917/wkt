...
class MysqlGenerator {
     ...
     *  文件路径
     */
    private static String packageName="wkt";
    /**
     *  作者
     */
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new StrategyConfig()
                        ...
                        //自定义 service 父类
                         .setSuperServiceClass("com.zmj."+packageName+".common.CommonManager")
                        // 自定义 service 实现类父类
                         .setSuperServiceImplClass("com.zmj."+packageName+".common.CommonManagerImpl")
                        // 自定义 controller 父类
                        .setSuperControllerClass("com.zmj."+packageName+".common.CommonController")
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.zmj."+packageName)// 自定义包路径
